...
namespace UniVCon.Editor
{
    public class ActionCreator : EditorWindow
    {
        ...
        private const string ActionRootFolderPath = "Assets/Scripts/Runtime/Samples/Actions";
        ...
        private void CreateAction()
        {
            ...
            var folderPath = Path.Combine(ActionRootFolderPath, _actionName);
        ...
        private string CreateActionScript(string folderPath)
        {
            ...
            File.WriteAllText(filePath, GetActionTemplate(), Utf8NoBom);
